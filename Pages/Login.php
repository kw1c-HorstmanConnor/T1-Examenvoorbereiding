    ...
    <section class="login-hero">
        ...
        <main class="login-main page-container">
            <form class="login-card" method="post" action="Login.php">
                ...
                <h1>Welkom terug</h1>
                <p class="login-card__copy">Log in met je e-mailadres en wachtwoord. De naam wordt gecontroleerd als voornaam wanneer je die invult.</p>
                ...
                <label class="login-field">
                    <span>Username</span>
                    <input type="text" name="username" autocomplete="given-name" value="<?= htmlspecialchars($username, ENT_QUOTES, 'UTF-8'); ?>">
                </label>
                ...
                <button class="login-submit" type="submit">Inloggen</button>
